...
use app\modules\jelou\models\Category;
use app\modules\jelou\models\Item;
...
class ItemsController extends Controller
{
            ...
            if(Yii::$app->request->isAjax){
                ...
                if (isset($_FILES) && $this->module->settings['articleThumb']) {
                    ...
                    if ($model->image && $model->validate(['image'])) {
                        $model->image = Image::upload($model->image, 'jelou');
                    } else {
                        $model->image = '';
                    }
                }
                ...
                if ($model->save()) {
                    $this->flash('success', Yii::t('easyii/jelou', 'Article created'));
    ...
    public function actionEdit($id)
    {
        ...
        if ($model->load(Yii::$app->request->post())) {
            if(Yii::$app->request->isAjax){
                ...
                if ($model->save()) {
                    $this->flash('success', Yii::t('easyii/jelou', 'Article updated'));
                    return $this->redirect(['/admin/'.$this->module->id.'/items/edit', 'id' => $model->primaryKey]);
                } else {
    ...
    public function actionDelete($id)
    {
        ...
        return $this->formatResponse(Yii::t('easyii/jelou', 'Article deleted'));
    }
